...
export const projects = [
  {
    title: "Plutopus",
    description: "AI-Powered Network Operations Intelligence Platform that ingests telemetry, correlates network incidents, and forecasts failures with topology-aware root cause analysis.",
    tech: ["FastAPI", "Next.js", "TimescaleDB", "Qdrant", "Ollama", "Docker", "Kubernetes"],
    status: "Open Source",
    year: "2026",
    link: "https://github.com/ayushkumar2601",
    code: "https://github.com/ayushkumar2601",
  ...
  {
    title: "Weth",
    description: "Zero-Trust AI Wallet enabling AI agents to inspect balances and simulate transactions using Model Context Protocol (MCP) without key access.",
