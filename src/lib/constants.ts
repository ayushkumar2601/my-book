...
export const achievementsData: I_Achievement[] = [
  {
    ...
    organization_link: "https://www.linkedin.com/posts/ayush-kumar-9003b5321_hackathon-ethindia-payload26-share-7432112623317381120-VJ4-?utm_source=social_share_send&utm_medium=member_desktop_web&rcm=ACoAAFFlFdABtgDPe4hnL-KUuGI07w-4lbONSxw",
  ...
  },
  {
    ...
    organization_link: "https://www.linkedin.com/posts/ayush-kumar-9003b5321_diversion2k26-hackathonwinner-apisecurity-ugcPost-7434179607605649408-TPgo?utm_source=social_share_send&utm_medium=member_desktop_web&rcm=ACoAAFFlFdABtgDPe4hnL-KUuGI07w-4lbONSxw",
...
export const projects = [
  {
    title: "RICO",
    description: "AI-powered API security scanner detecting vulnerabilities in APIs.",
    tech: ["Python", "CLI", "OpenAPI", "Security Testing", "AI Planning", "HTML Reports"],
    status: "Live",
    year: "2026",
  ...
  {
    title: "Bondbuy",
    description: "Fractional government bond investment platform using Solana NFTs.",
    tech: ["Next.js", "React", "Solana", "Phantom Wallet", "Web3", "NFT Minting"],
    status: "Live",
    year: "2026",
  ...
  {
    title: "Voxrt",
    description: "Cyberpunk NFT marketplace with AI pricing and wallet integration.",
    tech: ["React", "Vite", "Tailwind CSS", "Ethers.js", "Ethereum", "Gemini AI"],
    status: "Live",
    year: "2026",
  ...
  {
    title: "DocAI",
    description: "AI healthcare assistant analyzing symptoms and suggesting insights.",
  ...
  {
    title: "Unirivo",
    description: "AI and blockchain collaboration platform verifying student contributions.",
    tech: ["Next.js", "React", "MongoDB", "NextAuth", "Solana", "Mastra AI"],
    status: "In Development",
    year: "2026",
