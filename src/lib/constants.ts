...
export const projects = [
  ...
  {
    title: "Beanstick",
    description: "Autonomous fiat-to-crypto settlement network on Solana utilizing AI LP agents, zkTLS verification, and Neo4j graph routing to eliminate counterparty risk.",
    tech: ["Solana", "TypeScript", "Rust", "Neo4j", "zkTLS", "Next.js"],
    status: "Live",
    year: "2026",
    link: "https://beanstick.vercel.app/",
    code: "https://github.com/ayushkumar2601/beansol",
    imageSrc: "/projects/beanstick.png",
  },
  {
    title: "TransitOps",
    description: "Fleet and transport operations platform for managing vehicles, drivers, trips, maintenance, fuel expenses, compliance, and operational analytics in one dashboard.",
    tech: ["Next.js", "TypeScript", "Node.js", "PostgreSQL", "Tailwind CSS", "Analytics"],
    status: "Live",
    year: "2026",
    link: "https://odoo-transit-ops-teal.vercel.app/",
    code: "https://github.com/ayushkumar2601/odoo-TransitOps",
    imageSrc: "/projects/transitops.png",
  },
  {
    title: "RICO",
